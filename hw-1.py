...
def main():
    # 加载文件
    x = np.loadtxt('E:\\Documents\\Desktop\\Point Cloud\homework\\1\\data\\airplane\\airplane_0001.txt', delimiter=',')[
        :, 0:3]
    x_pca = hw_pca(x)
    # 显示
    ...
    ds_random = hw_downsample(x, take="random")
    ds_centroid = hw_downsample(x, take="centroid")
